        ...
        <div className={ `${(pathName === '/') ? 'bg-transparent' : 'bg-base-100 shadow-sm '} relative z-20`}>
            <div className=" navbar border-0 container mx-auto">
                <div className="navbar-start">
                    ...
                    <div tabIndex={0} role="button" className={`${(pathName === '/') ? 'bg-base-100 px-2 py-1' : ''} btn btn-ghost lg:hidden `}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /> </svg>
                    </div>
                    <ul
                        tabIndex="-1"
                        className={`${(pathName === '/') ? 'bg-red' : ''} menu menu-sm  dropdown-content bg-base-100 rounded-box z-9999 mt-3 w-52 p-2 shadow space-y-3`}>
                        {links}
                    </ul>
                    </div>
                ...
                <div className="navbar-end space-x-4">
                    ...
                    <Link className='btn btn-accent text-white hidden md:flex' href="/Register">
